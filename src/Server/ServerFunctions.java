...
public class ServerFunctions {
    ...
    public static String solveTask(String title) {
        ...
        try {
            ...
            if (!ans.equals("")) {
                ...
                fileWriter = new FileWriter("D://JavaProject/curs/enter/solved_goals.txt", true);
                fileWriter.write(title + "\n");
                fileWriter.write(description + "\n");
                fileWriter.flush();
                fileWriter.close();
    ...
    public static List<String> showDecisions() {
        File file = new File("D://JavaProject/curs/enter/solved_goals.txt");
        System.out.println(file.exists() + " " + file.getAbsolutePath());
        ArrayList<String> res = new ArrayList<>();
        try {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream("D://JavaProject/curs/enter/solved_goals.txt")));
            String tit;
            String descr;
            while ((tit = bufferedReader.readLine()) != null) {
                descr = bufferedReader.readLine();
